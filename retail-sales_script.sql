...
-----Checking Top 5 customers who generated the highest sales 
SELECT DISTINCT CUSTOMER_ID,SUM(QUANTITY*PRICE_PER_UNIT) AS Top_sales
FROM PEP_SALES.PEP_SHOP.PEP_DATA
GROUP BY CUSTOMER_ID
ORDER BY Top_sales DESC
LIMIT 5;

-----Checking Top 5 customers who generated the lowest sales 
SELECT DISTINCT CUSTOMER_ID,SUM(QUANTITY*PRICE_PER_UNIT) AS Lowest_sales
FROM PEP_SALES.PEP_SHOP.PEP_DATA
GROUP BY CUSTOMER_ID
